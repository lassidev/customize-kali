...
# spice-vdagent
sudo apt -qq update -y && sudo apt -qq full-upgrade -y && sudo apt -qq install -y python3-venv brave-browser flatpak seclists feroxbuster gobuster neovim remmina terminator fonts-hack-ttf python3-argcomplete code-oss rlwrap oscanner tnscmd10g redis-tools wkhtmltopdf
